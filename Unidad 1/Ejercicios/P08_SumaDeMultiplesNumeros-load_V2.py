...
qtCreatorFile = "P08_SumaDeMultiplesNumeros-load_V2.ui"  # Nombre del archivo aquí.
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.ruta_archivo = os.path.join("..", "..", "Archivos", "numeros.csv")
    ...
    def cargar(self):
       ...
       # nums=[float(i) for i in contenido]
        ...
        self.numeros=nums
        self.sumar()
        self.text_lista_numeros.setText(str(self.numeros))
    ...
    def guardar(self):
        archivo = open(self.ruta_archivo, "w")  # "w"=write (escritura / "a" = append
